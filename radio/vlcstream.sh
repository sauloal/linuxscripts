...
#--telnet-password XXXXXX --sout-keep --ttl 12 --random --file-caching 3000 --sout-standard-name=test2 --sout-shout-name=test2
...
COMMAND="${INTERFACE} ${MUSIC} ${SOUT} ${DEST} ${OPTIONS} ${CACHEOPT} > ${LOGFILE}"
